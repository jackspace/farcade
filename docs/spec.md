...
**Status**: sprint 1 under way, 2026-08-08. The work breakdown, roadmap tiers and risk register
live in [sprint-1.md](sprint-1.md); this document is the durable design.
...
Farcade is an LXMF application — a car on the road, not part of the road. It is not a
...
schemes — see the roadmap in sprint-1.md); this port does not pretend to support them.
...
- Every negative result needs a **positive control near the margin** (a control 45 dB inside the
  margin proved nothing about a target at the floor — that mistake is why this rule exists).
...
Out (tiered in sprint-1.md, not forgotten): every other transport, multiple concurrent games,
